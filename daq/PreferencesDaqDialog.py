...
class PreferencesDaqDialog(gtk.Dialog):
    __gtype_name__ = "PreferencesDaqDialog"
    prefernces = {}

    def __init__(self):
        """__init__ - This function is typically not called directly.
        Creation of a PreferencesDaqDialog requires redeading the associated ui
        file and parsing the ui definition extrenally,
        and then calling PreferencesDaqDialog.finish_initializing().

        Use the convenience function NewPreferencesDaqDialog to create
        NewAboutDaqDialog objects.
        """
    ...
    def finish_initializing(self, builder):
        ...
        and creating a AboutDaqDialog object with it in order to finish
        initializing the start of the new AboutDaqDialog instance.
        """
        ...
        self.__record_type = "http://wiki.ubuntu.com/Quickly/RecordTypes/Daq/Preferences"
    ...
    def get_preferences(self):
        ...
        preferences for daq. Creates a couchdb record if
        necessary.
        """
...
def NewPreferencesDaqDialog():
    """NewPreferencesDaqDialog - returns a fully instantiated
    PreferencesDaqDialog object. Use this function rather than
    creating a PreferencesDaqDialog instance directly.
    """

    #look for the ui file that describes the ui
    ui_filename = os.path.join(getdatapath(), 'ui', 'PreferencesDaqDialog.ui')
    if not os.path.exists(ui_filename):
        ui_filename = None

    builder = gtk.Builder()
    builder.add_from_file(ui_filename)
    dialog = builder.get_object("preferences_daq_dialog")
    dialog.finish_initializing(builder)
    return dialog

if __name__ == "__main__":
    dialog = NewPreferencesDaqDialog()
    dialog.show()
    gtk.main()
